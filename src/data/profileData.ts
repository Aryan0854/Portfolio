...
export const profileData: ProfileData = {
  ...
  experiences: [
    {
      ...
      company: "Airtel, Bangalore Karnataka",
      period: "August 2025 - Current",
      description: "Selected for a Data Science internship at Airtel, contributing to real-time ad optimization and consumer analytics. Gained hands-on experience in data modeling, machine learning, and campaign performance analysis under expert mentorship"
    },
    {
      title: "AI-ML Intern",
  ...
  certificates: [
    {
      id: "Offer2",
      title: "Offer Letter from Airtel",
      issuer: "Airtel",
